...
class Friction: Mover {
    ...
    init(_ view: AnimProxyKind2, _ callBack:@escaping FrameTick, _ value: CGFloat, _ velocity: CGFloat = 0, _ frictionStrength: CGFloat = 0.98) {
     ...
     * - Fixme: ⚠️️ it's easier and better to assert stillness by doing velocity.isNear(0, epsilon_value)
     */
    func checkForStop() {
