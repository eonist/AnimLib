import Foundation
/**
 * Fixme: ⚠️️ Make start method for each OS, makes things cleaner, then seperate in extensions
 */
extension FrameAnimator {
   ...
   @objc public func start() {
      guard stopped else { return } // Aka you don't have to start it if its already running (already stopped, return)
