...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Hybrid_iOS",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

@class NSCoder;

SWIFT_CLASS("_TtC10Hybrid_iOS11GraphicView")
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC10Hybrid_iOS6Button")
...
@interface Button (SWIFT_EXTENSION(Hybrid_iOS))
- (void)drawLayout;
@end
...
/// CheckBoxButton
SWIFT_CLASS("_TtC10Hybrid_iOS14CheckBoxButton")
...
/// view.addSubview(btn)
/// btn.selected = true
SWIFT_CLASS("_TtC10Hybrid_iOS11CheckButton")
...
@interface CheckButton (SWIFT_EXTENSION(Hybrid_iOS))
/// onTapUpInside
- (void)onUpInside;
@end
...
@interface GraphicView (SWIFT_EXTENSION(Hybrid_iOS))
- (void)layoutSubviews;
...
SWIFT_CLASS("_TtC10Hybrid_iOS10PlusButton")
...
SWIFT_CLASS("_TtC10Hybrid_iOS12SelectButton")
...
SWIFT_CLASS("_TtC10Hybrid_iOS10TextButton")
...
SWIFT_CLASS("_TtC10Hybrid_iOS20SelectableTextButton")
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC10Hybrid_iOS6Slider")
...
@interface Slider (SWIFT_EXTENSION(Hybrid_iOS))
- (void)layoutSubviews;
...
SWIFT_CLASS("_TtC10Hybrid_iOS7Spinner")
...
SWIFT_CLASS("_TtC10Hybrid_iOS7Stepper")
...
SWIFT_CLASS("_TtC10Hybrid_iOS6Switch")
...
/// SwitchButton
SWIFT_CLASS("_TtC10Hybrid_iOS12SwitchButton")
...
SWIFT_CLASS("_TtC10Hybrid_iOS16SwitchForeground")
...
@interface SwitchForeground (SWIFT_EXTENSION(Hybrid_iOS))
- (void)drawLayout;
@end
...
SWIFT_CLASS("_TtC10Hybrid_iOS12VolumeSlider")
